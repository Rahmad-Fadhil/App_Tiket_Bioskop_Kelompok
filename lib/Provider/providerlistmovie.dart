...
//   final List<Map<String, dynamic>> _daftarMovie = [
//     {
...
//   List<Map<String , dynamic>> get daftarMovie => _daftarMovie;

//   List<Map<String, dynamic>> filteredMoviesGenre(String genre) {
//     if (genre == 'All') {
//       return _daftarMovie;
//     }  else {
//       return daftarMovie.where((movie) => movie['genre'] == genre).toList();
//     }
//   }

//   List<Map<String, dynamic>> getMoviesByEvent(String event) {
//     return _daftarMovie.where((movie) => movie['event'].toLowerCase() == event.toLowerCase()).toList();
//   }
// }